...
Based on the results, k = 7 appears to be the optimal number of topics. While one could argue that 5 is also a valid choice if you want to simplify the analysis a bit, 7 improves the CaoJuan2009 metric while also improving the Deveaud2014 metric. They really couldn't come up with better names for these metrics?!?
